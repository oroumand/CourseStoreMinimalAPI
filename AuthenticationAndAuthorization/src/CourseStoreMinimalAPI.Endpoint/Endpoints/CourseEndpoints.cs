...
public static class CourseEndpoints
{
    ...
    public static WebApplication MapCourses(this WebApplication app, string prefix)
    {
        ...
        teacherGroup.MapPost("/", Insert).DisableAntiforgery().AddEndpointFilter<ValidationFilter<CourseSaveRequest>>();
        teacherGroup.MapPut("/{id:int}", Update).DisableAntiforgery().AddEndpointFilter<ValidationFilter<CourseSaveRequest>>();
