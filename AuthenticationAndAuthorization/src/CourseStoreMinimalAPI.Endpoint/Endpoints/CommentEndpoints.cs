...
public static class CommentEndpoints
{
    ...
    public static WebApplication MapComments(this WebApplication app, string prefix)
    {
        ...
        teacherGroup.MapPost("/", Insert).DisableAntiforgery().AddEndpointFilter<ValidationFilter<CommentRequest>>();
        teacherGroup.MapPut("/{id:int}", Update).DisableAntiforgery().AddEndpointFilter<ValidationFilter<CommentRequest>>();
